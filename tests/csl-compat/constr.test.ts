...
describe("PlutusMap complex", () => {
    let csl = CSL.PlutusMap.new();
    csl.insert(CSL.PlutusData.new_list(CSL.PlutusList.new()), CSL.PlutusMapValues.new());

    let cdl = CDL.PlutusMap.new();
    cdl.insert(CDL.PlutusData.new_list(CDL.PlutusList.new()), CDL.PlutusMapValues.new());
